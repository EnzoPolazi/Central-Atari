...
function drawBottomHud() {
  ...
  fillText('CREDITOS: ', CANVAS_WIDTH - 140, CANVAS_HEIGHT - 7.5);
  fillCenteredText('PONTOS: ' + player.score, CANVAS_WIDTH/2, 20);
...
function drawStartScreen() {
  ...
  fillBlinkingText("Aperte enter para jogar!", CANVAS_WIDTH/2, CANVAS_HEIGHT/1.4, 500, '#FFFFFF', 36);
  fillCenteredText("X - Atira", CANVAS_WIDTH/2, CANVAS_HEIGHT/2, '#FFFFFF', 35);
  fillCenteredText("Setas - Movimentam a Nave", CANVAS_WIDTH/2, CANVAS_HEIGHT/1.8, '#FFFFFF', 35);
}
